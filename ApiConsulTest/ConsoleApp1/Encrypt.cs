...
namespace ConsoleApp1
{
    public static class Encrypt
    {
        ...
        /// <returns></returns>
        public static string EncryptConvertJavaToCSharp(string _privateKey, string _tokenKey)
        {
            string datetimeWithKey = DateTime.Now.ToString("2020-MM-ddTHH:mm:ss.fff");
