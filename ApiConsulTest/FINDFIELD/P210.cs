...
namespace FINDFIELD
{
    class P210
    {
        static void MainP210(string[] args)
        {
            var tableName = "CBMSAPP210";
            ...
            procedureNames.ForEach(fProcedureName =>
            {
                ...
                declareLines.ForEach(declareLine =>
                {
                    ...
                    var aliasName = new List<string> {
                        varNameOfTable + ".prvActorName",
                        varNameOfTable + ".prvActorSurName",
                        varNameOfTable + ".curActorName",
                        varNameOfTable + ".curActorSurName"
                    };
